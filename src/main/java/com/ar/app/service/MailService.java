...
public class MailService {
	...
	public String sendOTPMail(User user, String otp) throws MessagingException, UnsupportedEncodingException {
		...
		String mailSubject = "Welcome to ChatApp";
		String mailContent = 
				"""
				<!DOCTYPE html>
				<html>
				...
				<body>
				  <div class="container">
				    <div class="header">
				      <img src='cid:logoImage' alt="ChatApp Logo" width="150" />
				      <h1 style="color: #ffffff;">ChatApp</h1>
				    </div>
				    <div class="description">
				      ...
				      <p>
				        Welcome to ChatApp! To log in, use the OTP (One-Time Password): <span class="otp">%s</span> sent to your email. The OTP will expire after 5 minutes, so be sure to use it promptly.
				      </p>
				    </div>
				    <div class="footer">
				      <a href="https://facebook.com/chatapp" target="_blank"><img src='cid:facebookIcon' alt="Facebook"></a>
				      <a href="https://twitter.com/chatapp" target="_blank"><img src='cid:twitterIcon' alt="Twitter"></a>
				      <a href="https://linkedin.com/chatapp" target="_blank"><img src='cid:linkedinIcon' alt="LinkedIn"></a>
		...
		helper.setFrom("donrahman6@gmail.com", "ChatApp Contact");
